...
import (
	"flag"
	"github.com/donetkit/nps-client/bridge"
	"github.com/donetkit/nps-client/lib/daemon"
	"log"
	"os"
	"os/exec"
	"path/filepath"
	...
	"github.com/donetkit/nps-client/server/connection"
	"github.com/donetkit/nps-client/server/tool"
	"github.com/donetkit/nps-client/web/routers"
